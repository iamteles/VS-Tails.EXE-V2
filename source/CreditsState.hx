...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - Role
			...
			['RaiGuyyy', 'rai' ,'I hate FNF so fucking much', 'https://twitter.com/RaiGuyyy', 'Voice Acting (Tails, Coughing Tails)'],
			['Mustard', 'mustard' ,'I came', 'https://twitter.com/Squijay1', 'Voice Acting (Origin Eggman)'],
