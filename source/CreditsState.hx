...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - Role
			...
			['MA - 1AJ', 'ma' ,'the person no one knows', 'https://twitter.com/1aj_ma', 'Artist'],
			...
			['Trikunari', 'triku' ,'Art.', 'https://twitter.com/Trikunari', 'Artist'],
			...
			['Rai', 'rai' ,'VA.', 'https://twitter.com/RaiGuyyy', 'Voice Acting'],
			...
			['The rest of the team', 'team', 'Thanks to whoever didnt get their work featured in the demo', '', 'Team'],
			['Sakurnyaw', 'saku', "Eggy's Icon", 'https://twitter.com/Sakurnyaw', 'Contributor'],
			...
			['BeastlyGhost', 'ghost', "Original idea for prepare sprite (from their engine Funkin' Feather)", 'https://twitter.com/BeastlyGabi', 'Contributor'],
